		...
		Context("Configured Cluster", Label("clean-cluster"), func() {
			...
			DescribeTable("Verifies ClusterImagePolicy signature validation",
				...
				Entry("Signed publicKey regular image passes validation",
					Label("crio-image-signature", "crio-image-signature-publickey",
						"crio-image-signature-regular", "crio-image-signature-positive"),
					reportxml.ID("90317"), SpecTimeout(10*time.Minute), "publickey-regular-signed"),
				Entry("Unsigned publicKey regular image fails validation",
					Label("crio-image-signature", "crio-image-signature-publickey",
						"crio-image-signature-regular", "crio-image-signature-negative"),
					reportxml.ID("90507"), SpecTimeout(8*time.Minute), "publickey-regular-unsigned"),
				Entry("Signed publicKey multi-arch image passes validation",
					Label("crio-image-signature", "crio-image-signature-publickey",
						"crio-image-signature-multiarch", "crio-image-signature-positive"),
					reportxml.ID("90319"), SpecTimeout(10*time.Minute), "publickey-multiarch-signed"),
				Entry("Unsigned publicKey multi-arch image fails validation",
					Label("crio-image-signature", "crio-image-signature-publickey",
						"crio-image-signature-multiarch", "crio-image-signature-negative"),
					reportxml.ID("90508"), SpecTimeout(8*time.Minute), "publickey-multiarch-unsigned"),
				Entry("Signed Certificate regular image passes validation",
					Label("crio-image-signature", "crio-image-signature-certificate",
						"crio-image-signature-regular", "crio-image-signature-positive"),
					reportxml.ID("90318"), SpecTimeout(10*time.Minute), "certificate-regular-signed"),
				Entry("Unsigned Certificate regular image fails validation",
					Label("crio-image-signature", "crio-image-signature-certificate",
						"crio-image-signature-regular", "crio-image-signature-negative"),
					reportxml.ID("90509"), SpecTimeout(8*time.Minute), "certificate-regular-unsigned"),
				Entry("Signed Certificate multi-arch image passes validation",
					Label("crio-image-signature", "crio-image-signature-certificate",
						"crio-image-signature-multiarch", "crio-image-signature-positive"),
					reportxml.ID("90320"), SpecTimeout(10*time.Minute), "certificate-multiarch-signed"),
				Entry("Unsigned Certificate multi-arch image fails validation",
					Label("crio-image-signature", "crio-image-signature-certificate",
						"crio-image-signature-multiarch", "crio-image-signature-negative"),
					reportxml.ID("90510"), SpecTimeout(8*time.Minute), "certificate-multiarch-unsigned"))
