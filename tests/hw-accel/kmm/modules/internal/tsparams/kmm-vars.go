...
var (
	...
	ReporterNamespacesToDump = map[string]string{
		...
		kmmparams.DRABackwardCompatTestNamespace:   "module",
		kmmparams.DRARemoveTestNamespace:           "module",
		kmmparams.DRAInTreeTestNamespace:           "module",
		kmmparams.DRAHappyPathTestNamespace:        "module",
		kmmparams.DRADeviceClassTestNamespace:      "module",
		kmmparams.DRAPresetEnvTestNamespace:        "module",
		kmmparams.DRAOptionalFeaturesTestNamespace: "module",
		kmmparams.DRATolerationTestNamespace:       "module",
		kmmparams.DRAPriorityTestNamespace:         "module",
		kmmparams.DRANoDeviceClassTestNamespace:    "module",
		kmmparams.DRAPullSecretTestNamespace:       "module",
		kmmparams.DRARemoveActiveTestNamespace:     "module",
